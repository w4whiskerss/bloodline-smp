package dev.whiskers.bloodline;

import dev.whiskers.bloodline.command.AbilityCommand;
import dev.whiskers.bloodline.command.BloodlineAdminCommand;
import dev.whiskers.bloodline.command.BloodlineCommand;
import dev.whiskers.bloodline.command.BloodDomainWandCommand;
import dev.whiskers.bloodline.command.BloodlineModCommand;
import dev.whiskers.bloodline.command.BloodlineReloadCommand;
import dev.whiskers.bloodline.command.BloodlineTestCommand;
import dev.whiskers.bloodline.command.GraceCommand;
import dev.whiskers.bloodline.config.GameplaySettings;
import dev.whiskers.bloodline.data.PlayerDataManager;
import dev.whiskers.bloodline.gui.AdminPanelGui;
import dev.whiskers.bloodline.gui.BloodlineGui;
import dev.whiskers.bloodline.gui.TestItemsGui;
import dev.whiskers.bloodline.item.CustomItems;
import dev.whiskers.bloodline.listener.BloodlineListener;
import dev.whiskers.bloodline.manager.BloodlineManager;
import dev.whiskers.bloodline.manager.GracePeriodManager;
import dev.whiskers.bloodline.network.ClientChannelBridge;
import dev.whiskers.bloodline.update.PluginUpdater;
import dev.whiskers.bloodline.world.WaterWorldGenerator;
...
public final class BloodlinePlugin extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        PluginCommand modCommand = getCommand("bloodlinehandshake");
        if (modCommand != null) {
        ...
        PluginCommand domainWandCommand = getCommand("blooddomainwand");
        if (domainWandCommand != null) {
            BloodDomainWandCommand executor = new BloodDomainWandCommand(this);
            domainWandCommand.setExecutor(executor);
            domainWandCommand.setTabCompleter(executor);
        }
