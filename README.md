...
[![paper](https://img.shields.io/badge/paper-1.20--1.21.11-7f1d1d?style=flat-square)](https://papermc.io/)
...
- A `Paper 1.20` through `1.21.11` server plugin
...
- Java `21`
- Paper `1.20` through `1.21.11` release builds only
